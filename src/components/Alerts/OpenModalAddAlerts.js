        ...
        <Box sx={style} className="modal_style">
            ...
            <div className="">
              <div className="modal-header px-3">
                <h4 className="modal-title pb-1" id="standard-modalLabel">
                  Add New Alert
                </h4>
                <button
              ...
              <div className="modal-body px-3">
                ...
                <div className="row">
                  <div className="col-md-12 modal-1 fw-bold">
                    <span className="me-2" style={{ paddingRight: "10px" }}>
                      Delivery Method
                    </span>
                    <input className="me-1" style={{ paddingRight: '10px' }} type="checkbox" />
              ...
              <div className="modal-footer mx-3">
                ...
                <button type="button" className="btnalert btn-primary add-alertbtn me-2" style={{color: 'white'}}>
                  Add Alert
                </button>
                <button
                  onClick={() => setOpen(false)}
