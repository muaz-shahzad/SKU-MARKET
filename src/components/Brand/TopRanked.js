                ...
                <div className="cardBrand">
                  ...
                  <div className="row table-style pt-3 pt-md-0 d-flex flex-direction-column justify-content-center justify-lg-start flex-lg-row align-items-center ">
                    ...
                    <div className="col-md-6 col-10 text-bold d-flex justify-content-center justify-content-lg-end table-header-right mt-2 mt-lg-0">
                      <div className="export btn filterbtncolor" style={{color: 'blue'}}>
                        <a href="//">
                          <i className="fa-solid fa-file-export"></i> Export
                        </a>
                      </div>
                      <div className="filter btn filterbtncolor" style={{ width: "64px",color: 'blue' }}>
                        <a href="//">Filter</a>
                      </div>
                    </div>
                  </div>
                      ...
                      >
                        ...
                        <div className="table-responsive">
                          <table className="table alert-Table">
                            <thead className="fs-6 fw-bold text-black grayheading">
                              <tr>
                                <th
                                ...
                                <th className="table-heading">Stores</th>
                                <th
                                  className="table-heading"
                                  tabindex="0"
                              ...
                              <td>
                                <div className="row d-flex flex-column flex-xl-row">
                                  ...
                                  <div className="col-lg-8 col-8">
                                    <a href="" className="text-bold blueText">
                                      N35997789A
                                    </a>
                  ...
                  <div className="row table-footer px-2">
                    ...
                    <div className="col-md-6 table-footer-right-topranked d-flex align-items-center justify-content-end">
                      <div className="paginationColor">
