  ...
  return (
    <>
      <div className="container-width">
        <div className="portfolio-body cardCategory shadowLight">
            ...
            <div className="row section-padding-tb d-flex flex-column flex-lg-row">
              <div className="col-md-4 col-lg-4 col-sm-2 col-11 mx-auto">
                <div className="">
                  ...
                  <span style={{ fontSize: "15px" }} className="pt-1 pt-lg-0"> Baby Products</span>{" "}
                  </div>
                  <br />
              ...
              <div className="col-md-2 col-lg-2 col-sm-2 col-11 mx-auto pt-5 pt-lg-0 d-flex align-items-end justify-content-center  justify-content-lg-end">
              ...
              <div className="col-md-3 col-lg-3 col-sm-2 col-11 pt-5 pt-lg-0 mx-auto d-flex align-items-end">
      ...
      <div className="container-width">
        <div
          className="portfolio-body cardCategory"
