                        ...
                        <div className="col-xxl-4 col-lg-5 col-md-5" style={{backgroundColor: '#f8f9fa !important'}}>
                            <div className="cardlogin" style={{backgroundColor: '#f8f9fa !important'}}>
                                ...
                                <div className="card-body2 p-4" style={{backgroundColor: '#f8f9fa !important'}}>
                                    ...
                                    <div className="text-center ">
                                        <h4 className="text-dark-50 text-center pb-0 fw-bold ">Free Sign Up</h4>
                                        <p className="text-muted mb-4 fs-5 px-4">Don't have an account? Create your account, it takes less than a minute</p>
                                    </div>

                                    <form action="#" style={{backgroundColor: '#f8f9fa !important'}}>
                                    <div className="mb-3">
                                            <label htmlFor="fullname" className="form-label fs-5">Full Name</label>
                                            <input className="form-control" type="text" id="emailaddress" required="" placeholder="Enter your full name" />
                                        </div>
                                        <div className="mb-3">
                                        ...
                                        <div className="mb-3 mb-3">
                                            ...
                                            <div className="mb-3 form-check d-flex align-items-center">
                                                ...
                                                <label className="form-check-label fs-5 text-black" htmlFor="exampleCheck1">I accept Terms and Conditions</label>
                                            </div>
                                        </div>

                                        <div className="mb-3 mb-0 text-center">
                                            <button className="py-1 px-2 fs-5 text-white border-none" type="submit" style={{border: 'none', borderRadius: '6px' ,color: 'white' , backgroundColor: '#1560FF'  }}> Sign Up </button>
                                        </div>
                            ...
                            <div className="row mt-3">
                                <div className="col-12 text-center">
                                    <p className="text-muted" >Already have account?  <a href="pages-register.html" className="text-muted ms-1 fw-bold fs-5"><b>Log In</b></a></p>
